...
paymentForm.include({
    ...
    async _prepareInlineForm(providerId, providerCode, paymentOptionId, paymentMethodCode, flow) {
        ...
        const inlineFormValues = JSON.parse(radio.dataset['multisafepayInlineFormValues']);
        ...
        if (!this.adyenCheckout) {
            await this.rpc('/payment/multisafepay/payment_methods', { // Await the RPC to let it create AdyenCheckout before using it.
        ...
        const adyenContainer = inlineForm.querySelector('[name="o_multisafepay_component_container"]');
    ...
    _adyenOnSubmit(state, component) {
        ...
        this.rpc(
            ...
            return this.rpc('/payment/multisafepay/payments', {
    ...
    _adyenOnSubmitAdditionalDetails(state, component) {
        this.rpc('/payment/multisafepay/payments/details', {
